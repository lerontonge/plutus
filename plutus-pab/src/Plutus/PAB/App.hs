...
appEffectHandlers storageBackend config trace contractHandler =
    EffectHandlers
        ...
        , handleContractEffect =
            ...
            . undefined -- TODO: . reinterpret contractHandler
        ...
        , handleServicesEffects = \wallet ->
            ...
            . interpret (Core.handleUserEnvReader @(Builtin a) @(AppEnv a))
            . reinterpret (Core.handleMappedReader @(AppEnv a) @Client.ChainSyncHandle chainSyncHandle)
            . interpret (Core.handleUserEnvReader @(Builtin a) @(AppEnv a))
            . reinterpret (Core.handleMappedReader @(AppEnv a) @Client.TxSendHandle txSendHandle)
            . interpret (Core.handleUserEnvReader @(Builtin a) @(AppEnv a))
